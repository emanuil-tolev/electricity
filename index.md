...
We measured the power consumption of a car dashcam (the 70mai A800SE 2025-10 purchase) by wiring it to a device which we configured to output 12.4V of power to simulate a 12V car battery. [More details on the project page.](dashcam-battery.md#how-long-will-this-camera-last-in-parking-mode-using-the-cars-12v-battery)
